...
class Knight_PIRANHAGUN(Character):
    ...
    def __init__(self, world, image, base, position):
        ...
        seeking_state = KnightStateSeeking_PIRANHAGUN(self)
        attacking_state = KnightStateAttacking_PIRANHAGUN(self)
        ko_state = KnightStateKO_PIRANHAGUN(self)
        fleeing_state = KnightStateFleeing_PIRANHAGUN(self)
    ...
    def process(self, time_passed):
        ...
        level_up_stats = ["hp", "speed", "melee damage", "melee cooldown", "healing cooldown"]
        if self.can_level_up():
            if self.healing_cooldown >self.melee_cooldown:
                choice = 4
            else:
                choice = 0
...
class KnightStateSeeking_PIRANHAGUN(State):
    ...
    def check_conditions(self):
        #check hp
        #if self.knight.current_hp<self.knight.max_hp/4:
         #   return "fleeing"
...
class KnightStateAttacking_PIRANHAGUN(State):
    ...
    def check_conditions(self):
        ...
        #if self.knight.current_hp<self.knight.max_hp/2:
...
class KnightStateKO_PIRANHAGUN(State):
...
class KnightStateFleeing_PIRANHAGUN(State):
    ...
    def check_conditions(self):
        ...
        # check knight hp
        if self.knight.current_hp>self.knight.max_hp*3/4:
            return "seeking"
